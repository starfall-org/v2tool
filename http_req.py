...
def get_response(url):
    ...
    links = []
    if any(
        proto in response for proto in ["vmess:", "trojan:", "vless:"]
        ):
        for link in response.splitlines():
            if any(
                proto in link for proto in ["vmess:", "trojan:", "vless:"]
                ):
                links.append(link)
    elif any(
        proto in response for proto in ["http:", "https:"]
        ):
...
def get_responses(urls):
    ...
    def process(url):
        ...
        if any(
            proto in sub_response for proto in ["vmess:", "trojan:", "vless:"]
            ):
